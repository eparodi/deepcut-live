...
- **Created:** 2026-08-13
- **Purpose:** the single design contract for every shared component.
  Each entry documents JSON-serializable props, data-bound states,
  tokens only, and action semantics so engineers never make design
  decisions and every screen composes from documented entries.
