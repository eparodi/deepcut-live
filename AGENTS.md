...
**Generic learnings live in ONE shared place:** the skills-test repo
(`skills-test/AGENTS.md`, Section 10) — code style, tool discipline,
UI, ops, payload verification, deploy ordering, and everything else
not specific to this project. Cite them as "skills-test AGENTS.md
§10: <rule name>". This section keeps only deepcut-live-specific
learnings; none exist yet.
